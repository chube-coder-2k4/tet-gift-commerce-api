...
public class OrderController {
    ...
    public ResponseEntity<ResponseData<OrderResponse>> getOrder(@PathVariable Long id) {
        return ResponseEntity
                .ok(new ResponseData<>(HttpStatus.OK.value(), "Order fetched", orderService.getOrderById(id)));
    }
    ...
    public ResponseEntity<ResponseData<PageResponse<OrderResponse>>> getMyOrders(
        ...
        return ResponseEntity
                .ok(new ResponseData<>(HttpStatus.OK.value(), "Orders fetched", orderService.getMyOrders(page, size)));
    }
    ...
    public ResponseEntity<ResponseData<OrderResponse>> cancelOrder(@PathVariable Long id) {
        return ResponseEntity
                .ok(new ResponseData<>(HttpStatus.OK.value(), "Order cancelled", orderService.cancelOrder(id)));
    }
}
