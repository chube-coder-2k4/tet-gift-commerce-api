...
public interface ProductService {
    ...
    Long saveProduct(ProductRequest productRequest, MultipartFile[] images) throws java.io.IOException;
    ...
    Long updateProduct(Long id, ProductRequest productRequest, MultipartFile[] images) throws java.io.IOException;
